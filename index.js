...
//
const BotName = '➸ROTBOT 🤖'; // Nama Bot Whatsapp
const instagramlu = 'https://instagram.com/creator_official03'; // Nama Instagramlu cok
const whatsapplu = 'wa.me/6282328023356'; // Nomor whatsapplu cok
...
conn.on('qr', qr =>
{
   ...
   console.log(`[ ${moment().format("HH:mm:ss")} ] R07-ID Ready scan now!`);
});
...
conn.on('user-presence-update', json => console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by @R07_ID`))
conn.on('message-status-update', json =>
{
   const participant = json.participant ? ' (' + json.participant + ')' : '' // participant exists when the message is from a group
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by @R07_ID`)
})
...
conn.sendMessage(id, 'Owner FIKRI LANGKAP wa.me/6282328023356?text=Assalamualaikum+bang' ,MessageType.text);
}
...
//Tolonglah bro jangan di ubah ubah FIKRI LANGKAP
