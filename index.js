...
* hargai pembuat skrip woy!!! JAN DI UBAH UBAH NANTI ERROR NANGIS!!
*/
const ROOTBOT = 'BOT R07'; // JANGAN DI UBAH NNTI EROR
const instagram = 'https://instagram.com/creator_official03'; // JANGAN DI UBAH NNTI EROR
const nomer = 'https://Wa.me/6282328023356'; // JANGAN DI UBAH NANTI EROR
...
const jr = require("./lib/jr.js");
const donate = require("./lib/donate.js");
const info = require("./lib/info.js");
const jr1 = require("./lib/jr1.js");
const jr2 = require("./lib/jr2.js");
const jr3 = require("./lib/jr3.js");
const jr4 = require("./lib/jr4.js");
const jr5 = require("./lib/jr5.js");
...
conn.on('qr', qr =>
{
   ...
   console.log(`[ ${moment().format("HH:mm:ss")} ] Tn_R07/Tn_Djarot Ready scan now!`);
});
...
conn.on('user-presence-update', json => console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by @Tn_Dj4r07`))
conn.on('message-status-update', json =>
{
   const participant = json.participant ? ' (' + json.participant + ')' : '' // participant exists when the message is from a group
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by @Tn_Dj4r07`)
})
...
conn.on('message-new', async(m) =>
{
   ...
   console.log(`[ ${moment().format("HH:mm:ss")} ] => Nomor: [ ${id.ROOTBOT("@s.whatsapp.net")[0]} ] => ${text}`);
   // Groups
...
conn.sendMessage(id, 'pa pe pa pe punya agamakan salam ngapa tod!!' ,MessageType.text);
}
else if (text == 'P'){
conn.sendMessage(id, 'pa pe pa pe punya agamakan salam ngapa tod!!' ,MessageType.text);
}
...
conn.sendMessage(id, 'Owner BOTLENT wa.me/+6282328023356' ,MessageType.text);
}
else if (text == 'Bang'){
conn.sendMessage(id, 'aku pembuat Lent bot & Programer' ,MessageType.text);
}
else if (text == 'Atri'){
conn.sendMessage(id, 'pacar Tn Djarot' ,MessageType.text);
}
...
conn.sendMessage(id, ' *COMMAND PREMIUM CHAT WA https://wa.me/6282328023356* ' ,MessageType.text);
}
else if (text == 'Woi'){
conn.sendMessage(id, 'Ya?, Ketik .help/.info/.donasi Contoh #help' ,MessageType.text);
}
...
conn.sendMessage(id, 'kawan1 iskandar wa.me/+6282328023356' ,MessageType.text);
}
else if (text == '.coowner'){
conn.sendMessage(id, 'kawan2 testing script wa.me/+6282328023356?text=TIDAK+ADA(SOLO+PLAYER)' ,MessageType.text);
}
...
conn.sendMessage(id, jr.jr(id, ROOTBOT, corohelp, tampilTanggal, tampilWaktu, instagram, nomer, aktif, groupwa, youtube) ,MessageType.text);
}
if (text == '.tools1'){
const corohelp = await get.get('https://covid19.mathdro.id/api/countries/id').json()
var date = new Date();
...
var tampilTanggal = "TANGGAL: " + hari + ", " + tanggal + " " + bulan + " " + tahun;
var tampilWaktu = "JAM: " + jam + ":" + menit + ":" + detik;
conn.sendMessage(id, jr1.jr1(id, ROOTBOT, corohelp, tampilTanggal, tampilWaktu, instagram, nomer, aktif, groupwa, youtube) ,MessageType.text);
}
if (text == '.tools2'){
const corohelp = await get.get('https://covid19.mathdro.id/api/countries/id').json()
var date = new Date();
...
var tampilTanggal = "TANGGAL: " + hari + ", " + tanggal + " " + bulan + " " + tahun;
var tampilWaktu = "JAM: " + jam + ":" + menit + ":" + detik;
conn.sendMessage(id, jr2.jr2(id, ROOTBOT, corohelp, tampilTanggal, tampilWaktu, instagram, nomer, aktif, groupwa, youtube) ,MessageType.text);
}
if (text == '.tools3'){
const corohelp = await get.get('https://covid19.mathdro.id/api/countries/id').json()
var date = new Date();
...
var tampilTanggal = "TANGGAL: " + hari + ", " + tanggal + " " + bulan + " " + tahun;
var tampilWaktu = "JAM: " + jam + ":" + menit + ":" + detik;
conn.sendMessage(id, jr3.jr3(id, ROOTBOT, corohelp, tampilTanggal, tampilWaktu, instagram, nomer, aktif, groupwa, youtube) ,MessageType.text);
}
if (text == '.tools4'){
const corohelp = await get.get('https://covid19.mathdro.id/api/countries/id').json()
var date = new Date();
...
var tampilTanggal = "TANGGAL: " + hari + ", " + tanggal + " " + bulan + " " + tahun;
var tampilWaktu = "JAM: " + jam + ":" + menit + ":" + detik;
conn.sendMessage(id, jr4.jr4(id, ROOTBOT, corohelp, tampilTanggal, tampilWaktu, instagram, nomer, aktif, groupwa, youtube) ,MessageType.text);
}
if (text == '.tools5'){
const corohelp = await get.get('https://covid19.mathdro.id/api/countries/id').json()
var date = new Date();
...
var tampilTanggal = "TANGGAL: " + hari + ", " + tanggal + " " + bulan + " " + tahun;
var tampilWaktu = "JAM: " + jam + ":" + menit + ":" + detik;
conn.sendMessage(id, jr5.jr5(id, ROOTBOT, corohelp, tampilTanggal, tampilWaktu, instagram, nomer, aktif, groupwa, youtube) ,MessageType.text);
}
else if (text == '.donate'){
const corohelp = await get.get('https://covid19.mathdro.id/api/countries/id').json()
var date = new Date();
...
var tampilTanggal = "TANGGAL: " + hari + ", " + tanggal + " " + bulan + " " + tahun;
var tampilWaktu = "JAM: " + jam + ":" + menit + ":" + detik;
conn.sendMessage(id, donate.donate(id, ROOTBOT, corohelp, tampilTanggal, tampilWaktu, instagram, nomer, aktif, groupwa, youtube) ,MessageType.text);
}
else if (text == '.donasi'){
const corohelp = await get.get('https://covid19.mathdro.id/api/countries/id').json()
var date = new Date();
...
var tampilTanggal = "TANGGAL: " + hari + ", " + tanggal + " " + bulan + " " + tahun;
var tampilWaktu = "JAM: " + jam + ":" + menit + ":" + detik;
conn.sendMessage(id, donate.donate(id, ROOTBOT, corohelp, tampilTanggal, tampilWaktu, nomer, aktif, groupwa, youtube) ,MessageType.text);
}
else if (text == '.DONATE'){
const corohelp = await get.get('https://covid19.mathdro.id/api/countries/id').json()
var date = new Date();
...
var tampilTanggal = "TANGGAL: " + hari + ", " + tanggal + " " + bulan + " " + tahun;
var tampilWaktu = "JAM: " + jam + ":" + menit + ":" + detik;
conn.sendMessage(id, info.info(id, ROOTBOT, corohelp, tampilTanggal, tampilWaktu, instagram, nomer, aktif, groupwa, youtube) ,MessageType.text);
}
else if (text == '.foto'){
conn.sendMessage(id, 'kirim .foto cewek/cowok\n\nContoh: .foto cewek' ,MessageType.text);
}
else if (text == '.help'){
conn.sendMessage(id, ' _TERIMAKASIH BANYAK TELAH MENGGUNAKAN FITUR INI...UNTUK PEMBUATAN BOT INI CEK CHANEL R07-ID TINGGALKAN SUBSCRIBE YHA' ,MessageType.text);
}
else if (text == '.tools1'){
conn.sendMessage(id, ' _🗣️Thanks Telah Menggunakan BOT *👾ROTBOT👾* , Follow Instagram Mimin Yah😻 : https://instagram.com/@creator_official03' ,MessageType.text);
}
else if (text == '.menu'){
conn.sendMessage(id, ' _🗣️Thanks Telah Menggunakan BOT *👾ROTBOT👾* , Follow Instagram Mimin Yah😻 : https://instagram.com/@creator_official03' ,MessageType.text);
}
...
//Tolonglah bro jangan di ubah ubah R07-ID
